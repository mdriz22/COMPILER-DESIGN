...
/*#define YY_USE_CLASS 
*/
/*  A Bison++ parser, made from variableyacc.y  */
...
const int YY_parse_CLASS::let=258;
const int YY_parse_CLASS::dig=259;
...
static const char * const yytname[] = {   "$","error","$illegal.","let","dig",
"'\\n'","TERM","XTERM",""
};
#endif
...
-32768,-32768,    -3,-32768,-32768,-32768,     4,     6,-32768
};
...
case 1:
#line 9 "variableyacc.y"
{printf("\nAccepted\n");exit(0);;
    break;}
case 2:
#line 10 "variableyacc.y"
{yyerror("\nRejected");
exit(0);
;
    break;}
